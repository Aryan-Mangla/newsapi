...
def embed_articles(articles, model_name='all-MiniLM-L6-v2'):
    """
...
if __name__ == "__main__":
    ...
    json_path = 'israel.json'
    main(json_path)

# Additional configuration options
# Experiment with these parameters to fine-tune clustering
# - Change model in embed_articles() for different embedding strategies
# - Adjust eps and min_samples in cluster_articles() to change cluster sensitivity